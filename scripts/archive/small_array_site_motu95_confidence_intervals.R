...
real_and_errors <- randomized_ranges(netlists, indices = chosen_ind, network_level = 'higher', out_format = 'data.frame', quantiles_to_return = c(0.025, 0.975), actual_vals = T, n_perm = 50)

outname <- paste('data/output_data/randomized_ranges/smaller_', chosen_ind, '.csv', sep = '')
